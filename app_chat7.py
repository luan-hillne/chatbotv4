...
async def post(
    ...
    logging = Logger_Days(f"./logs/logchatbot/logchatbot_{str(config_app['server']['port'][6])}" + '_' + current_date)
...
uvicorn.run(app, host="0.0.0.0", port=config_app['server']['port'][6])